...
const ProductViewModal = ({ isOpen = true, onClose, productDetails }) => {
  useEffect(() => {
  ...
  return (
    <div
      className={`fixed  top-0 left-0 z-50 bg-[#2222227c] overflow-x-hidden overflow-y-auto inset-0 h-[calc(100%)] max-h-full bg-black/90 flex flex-col justify-center items-center modal-overlay  ${
        isOpen ? "" : "hidden"
      }`}
    >
      <div className="bg-white rounded-lg p-5 shadow-lg w-[350px] md:w-[700px] md:h-[450px] lg:w-[750px] lg:h-[465px] zoom-in-element overflow-y-auto">

    ...
    <div>
      ...
      >
        <div className="flex items-center justify-center">
          <img
            className={cn(`h-32 w-32 lg:h-52 lg:w-full group-hover:scale-105 duration-500`, imageSize)}
        ...
        <div className="absolute top-5 left-5">
          <div className="flex flex-col gap-3">
            ...
            <FaSearch className="w-9 h-9 p-2 rounded-full bg-white shadow-md border hover:bg-primary hover:text-white duration-500 cursor-pointer" />
          </div>
        </div>
      </div>
